...
class danhGiaSanPhamModel
{
    ...
    {
        global $wpdb;
        $results = $wpdb->get_results('SELECT * FROM danhgiasanpham');
        return $results;
    }
    ...
    public function calculate_average()
    {
        ...
        $average = $wpdb->get_var("SELECT AVG(diemDanhGia) FROM danhgiasanpham WHERE maSanPham=$this->maSanPham AND diemDanhGia > 0");
        return $average;
    }
