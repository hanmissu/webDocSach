...
<script>
    ...
    var DEFAULT_URL = "<?php echo  PLUGIN_QUANLYSACH_FILE . '/' . $tenTheLoai . '/' . $dataSanPham[0]->tenFile ?> ";
    ...
    PDFJS.imageResourcesPath = '<?php echo  THEME_URL . '/template-parts/pdf-flipbook-master/images' ?>';
    PDFJS.workerSrc = '<?php echo  THEME_URL . '/template-parts/pdf-flipbook-master/pdfjs/build/pdf.worker.js' ?>';
    PDFJS.cMapUrl = '<?php echo  THEME_URL . '/template-parts/pdf-flipbook-master/pdfjs/cmaps/' ?>';
