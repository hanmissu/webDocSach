! function(modules) {
    ...
    var BaseMathUtils = function() {
        ...
        return BaseMathUtils.sum1 = function(ka, a, kb, b) { return [ka * a[0] + kb * b[0]] }, BaseMathUtils.sum2 = function(ka, a, kb, b) { return [ka * a[0] + kb * b[0], ka * a[1] + kb * b[1]] }, BaseMathUtils.sum3 = function(ka, a, kb, b) { return [ka * a[0] + kb * b[0], ka * a[1] + kb * b[1], ka * a[2] + kb * b[2]] }, BaseMathUtils.sum4 = function(ka, a, kb, b) { return [ka * a[0] + kb * b[0], ka * a[1] + kb * b[1], ka * a[2] + kb * b[2], ka * a[3] + kb * b[3]] }, BaseMathUtils.rk4 = function(dy, t, dt, y) {
            ...
            if (Math.abs(d) > BaseMathUtils.eps) { res = { x: BaseMathUtils.det2(b1, a1[1], b2, a2[1]) / d, y: BaseMathUtils.det2(a1[0], b1, a2[0], b2) / d } }
            return res
            ...
            for (; !done;) {
                ...
                for (var np = { x: p.x + Math.random() - .5, y: p.y + Math.random() - .5 }, rn = { x: np.x - p.x, y: np.y - p.y }, a1 = [rn.y, -rn.x], b1 = p.x * rn.y - p.y * rn.x, _i5 = 0; _i5 < ps.length; ++_i5) {
                    var p0 = ps[_i5],
    ...
    var Utils = function() {
        ...
        }, Utils._escapeHTMLclb = function(c) { return Utils._escapeHTMLchars[c] || c }, Utils.escapeHTML = function(s) { return s.replace(/[&<>]/g, Utils._escapeHTMLclb) }, Utils.extends = function(der, base) { for (var name in base) der.hasOwnProperty(name) || (der[name] = base[name]) }, Utils.defaultCmp = function(a, b) { return a - b }, Utils.lowerBound = function(a, x, cmp) {
    ...
    var _libs = __webpack_require__(0),
        ...
        _BaseMathUtils3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_BaseMathUtils2),
    ...
    var _GraphUtils = __webpack_require__(4),
        _GraphUtils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_GraphUtils),
        ImageBase = function() {
            function ImageBase(context, width, height, color) { _classCallCheck(this, ImageBase), this.renderPause = !1, this.context = context, this.wnd = context.wnd, this.doc = context.doc, this.element = context.element || context.doc.body, this.c = context.renderCanvas || ImageBase.renderCanvas, this.ctx = context.renderCanvasCtx || ImageBase.renderCanvasCtx, this.resW = this.width = width, this.resH = this.height = height, this.color = color }
            return ImageBase.prototype.setRenderCanvas = function(c, ctx) { this.c = c, this.ctx = ctx }, ImageBase.prototype.setResolution = function(res) {
                var k = res.width / this.resW;
                this.resW = res.width, this.resH = k * this.resH
            }, ImageBase.prototype.dispose = function() {}, ImageBase.prototype.renderBlankPage = function() { this.ctx.beginPath(), this.ctx.fillStyle = _GraphUtils2.default.color2Rgba(this.color, 1), this.ctx.rect(0, 0, this.c.width, this.c.height), this.ctx.fill() }, ImageBase.prototype.setRenderPause = function(renderPause) { this.renderPause = renderPause, !renderPause && this.continueRender && (this.continueRender(), delete this.continueRender) }, ImageBase.prototype.cancelRender = function() { this.renderTask && this.renderTask.cancel && (this.renderTask.cancel(), delete this.renderTask) }, ImageBase.prototype.renderImage = function(image) { this.pushCtx(), this.ctx.clearRect(0, 0, this.c.width, this.c.height), this.ctx.drawImage(image, 0, 0), this.popCtx() }, ImageBase.prototype.normToConv = function(p) { return { x: p.x * this.c.width, y: (1 - p.y) * this.c.height } }, ImageBase.prototype.renderHit = function(poly) {
                var ctx = this.ctx;
            ...
            }, ImageBase.prototype.pushCtx = function() { return Math.abs(this.resW - this.c.width) >= 1 && (this.c.width = Math.ceil(this.resW)), Math.abs(this.resH - this.c.height) >= 1 && (this.c.height = Math.ceil(this.resH)), this.ctx.save(), this.ctx.scale(this.c.width / this.width, this.c.height / this.height), this.ctx }, ImageBase.prototype.popCtx = function() { this.ctx.restore() }, ImageBase.prototype.renderNotFoundPage = function() { this.renderBlankPage() }, ImageBase.prototype.finishRender = function() {
                var canceled = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                this.onChange && this.onChange(this.c, canceled)
            }, ImageBase.prototype.finishLoad = function() { this.onLoad ? this.onLoad() : this.startRender() }, ImageBase.prototype.getSimulatedDoc = function() {}, ImageBase
        }();
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        _BaseMathUtils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_BaseMathUtils),
        BookPropsBuilder = function() {
            function BookPropsBuilder(onReady, style) { _classCallCheck(this, BookPropsBuilder), this.onReady = onReady, this.defaults = (0, _book.props)(style) }
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) { return typeof obj } : function(obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj },
        ...
        SheetBlock = function() {
            function SheetBlock(visual, p, first, last) {
                ...
                Object.keys(loadedPoints).map(function(k) { _this[k] = loadedPoints[k][props.shape] || loadedPoints[k][0] }), this.pSpline = new _libs.THREE.CatmullRomCurve3([]);
            ...
            return SheetBlock.prototype.dispose = function() {
            ...
            }, SheetBlock.prototype.getSize = function() { return this.p.last - this.p.first }, SheetBlock.prototype.getProps = function() { return _extends({}, this.p.page, { width: this.p.page.width - (this.reducedWidth ? .001 * this.p.page.width : 0), sheets: this.p.sheets }) }, SheetBlock.prototype.reduceWidth = function(reducedWidth) { this.reducedWidth = reducedWidth, this.set(this.angle) }, SheetBlock.prototype.getTopCerners = function() { var off = this.angle > Math.PI / 2 ? 0 : this.geometry.vertices.length / 2; return [this.geometry.vertices[off], this.geometry.vertices[_sheetBlock2.default.resX - 1 + off], this.geometry.vertices[(_sheetBlock2.default.resZ - 1) * _sheetBlock2.default.resX + off], this.geometry.vertices[_sheetBlock2.default.resZ * _sheetBlock2.default.resX - 1 + off]] }, SheetBlock.prototype.getTopSize = function() {
                var vs = this.getTopCerners(),
                    w0 = new _libs.THREE.Vector3,
                    w1 = new _libs.THREE.Vector3;
                return w0.copy(vs[0]), this.three.localToWorld(w0), w1.copy(vs[1]), this.three.localToWorld(w1), { width: Math.abs(w1.x - w0.x), height: vs[0].distanceTo(vs[2]) }
            }, SheetBlock.prototype.getTopWorldRotation = function(q) { return q.x = -Math.PI / 2, q }, SheetBlock.prototype.getTopWorldPosition = function(v) {
                var vs = this.getTopCerners();
                v.set(0, -100, 0);
                ...
                if (this.corner.use && Math.abs(this.corner.height) > .001) {
                    ...
                    for (var _iterator5 = this.corner.points, _isArray5 = Array.isArray(_iterator5), _i8 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
                        ...
                        var point = _ref5;
                        this.geometry.vertices[point.vertex].applyAxisAngle(this.corner.axis, function(d) { return p.cornerDeviation * _this2.corner.height / (1 + Math.exp(-p.bending * (d - .5 * _this2.corner.maxDistance))) }(point.distance))
                    }
                }
                ...
                return ps
            }, SheetBlock.prototype.interpolate = function(x, y, xi) { if (!this.aSplines[x.length]) { this.aSplines[x.length] = new _libs.THREE.CatmullRomCurve3([]); for (var ps = this.aSplines[x.length].points, i = 0; i < x.length; ++i) ps.push(new _libs.THREE.Vector3) } for (var spline = this.aSplines[x.length], _i10 = 0; _i10 < x.length; ++_i10) spline.points[_i10].set(x[_i10], y[_i10], 0); return spline.getPoint(Math.min(1, Math.max(xi, 0))).y }, SheetBlock.prototype.loadPoints = function() {
                ...
                return {
                    ...
                    openedInterpolationIndeces: [{ left: [2, 3, 4], right: [2, 3, 4] }, { left: [2, 6, 5], right: [2, 3, 4] }, { left: [2, 3, 4], right: [2, 3, 4] }],
    ...
    function props() {
        var style = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "volume",
            def = { height: .297, width: .21, backgroundColor: "", backgroundImage: "", backgroundStyle: "", highlightLinks: !0, lighting: "mixed", gravity: 1, cachedPages: 50, renderInactivePages: !0, renderInactivePagesOnMobile: !0, renderWhileFlipping: !1, pagesForPredicting: 5, preloadPages: 5, autoPlayDuration: 5e3, rtl: !1, interactiveCorners: !0, maxDepth: .008, sheet: { startVelocity: 1.2, cornerDeviation: .15, flexibility: 10, flexibleCorner: .5, bending: 11, wave: .3, shape: 0, widthTexels: 1920, heightTexels: 1080, color: 16777215, side: "color" }, cover: { side: "transparent", binderTexture: "", depth: 3e-4, padding: 0, mass: .001 }, page: { depth: 1e-4, mass: .001 }, cssLayerProps: { width: 1024 } },
            styles = { volume: def, flat: _extends({}, def, { lighting: "ambient", sheet: _extends({}, def.sheet, { wave: .05, side: "transparent", shape: 1 }), cover: _extends({}, def.cover, { depth: 2e-5 }), page: _extends({}, def.page, { depth: 1e-5 }) }), "volume-paddings": _extends({}, def, { cover: _extends({}, def.cover, { padding: .0025 }) }) };
        return styles["volume-unrolling"] = _extends({}, styles.volume, { sheet: _extends({}, styles.volume.sheet, { shape: 1 }) }), styles["volume-paddings-unrolling"] = _extends({}, styles["volume-paddings"], { sheet: _extends({}, styles["volume-paddings"].sheet, { shape: 1 }) }), styles[style] || def
    }
    exports.__esModule = !0;
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target };
    exports.props = props
    ...
    _libs.THREE.CSS3DObject = function(_THREE$Object3D) {
        ...
        function epsilon(value) { return Math.round(1e5 * (value + Number.EPSILON)) / 1e5 }

        function getCameraCSSMatrix(matrix) { var elements = matrix.elements; return "matrix3d(" + [epsilon(elements[0]), epsilon(-elements[1]), epsilon(elements[2]), epsilon(elements[3]), epsilon(elements[4]), epsilon(-elements[5]), epsilon(elements[6]), epsilon(elements[7]), epsilon(elements[8]), epsilon(-elements[9]), epsilon(elements[10]), epsilon(elements[11]), epsilon(elements[12]), epsilon(-elements[13]), epsilon(elements[14]), epsilon(elements[15])].join(",") + ")" }
        ...
        function zOrder(scene) {
            var order = Object.keys(cache.objects).sort(function(a, b) { return cache.objects[a].distanceToCameraSquared - cache.objects[b].distanceToCameraSquared }),
                zMax = order.length;
            scene.traverse(function(object) { var index = order.indexOf(object.id + ""); - 1 !== index && (object.element.style.zIndex = zMax - index) })
        }
    ...
    var _libs = __webpack_require__(0),
        ...
        CSSLayer = function(_CSS3DObject) {
            function CSSLayer(width, height, props) { _classCallCheck(this, CSSLayer); var _this = _possibleConstructorReturn(this, _CSS3DObject.call(this)); return _this.props = props, _this.jContainer = (0, _libs.$)('<div class="hidden css-layer"></div>'), _this.setSize(width, height), _this.setData(), _this.set(_this.jContainer[0]), _this }
            return _inherits(CSSLayer, _CSS3DObject), CSSLayer.init = function(doc) {
            ...
            }, CSSLayer.dispose = function() { CSSLayer.style.remove() }, CSSLayer.prototype.setSize = function(width, height) {
                ...
                setTimeout(function() { timestamp === _this2.timestamp && clb() }, .5 * CSSLayer.delay)
    ...
    var _EventConverter2 = __webpack_require__(7),
        _EventConverter3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_EventConverter2),
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        _Utils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_Utils),
        Finder = function() {
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        _Utils = __webpack_require__(3),
        _Utils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_Utils);
    _libs.PDFJS.GlobalWorkerOptions.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({ pdfJsWorker: "js/pdf.worker.js", pdfJsCMapUrl: "cmaps/" })).pdfJsWorker, _libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({ pdfJsWorker: "js/pdf.worker.js", pdfJsCMapUrl: "cmaps/" })).pdfJsCMapUrl, _libs.PDFJS.cMapPacked = !0, _libs.PDFJS.disableAutoFetch = !0, _libs.PDFJS.disableStream = !0, _libs.PDFJS.disableRange = !1, _libs.PDFJS.imageResourcesPath = "images/pdfjs/", _libs.PDFJS.externalLinkTarget = _libs.PDFJS.LinkTarget.BLANK, _libs.PDFJS.disableFontFace = void 0;
    var Pdf = function() {
        function Pdf(src, loadingProgress, openOptions) {
            var _this = this;
            _classCallCheck(this, Pdf), this.src = _Utils2.default.normalizeUrl(src), this.handlerQueue = [], this.progresData = { loaded: -1, total: 1 }, this.loadingProgress = loadingProgress, this.task = _libs.PDFJS.getDocument(_extends({ url: this.src, rangeChunkSize: 524288, cMapUrl: _libs.PDFJS.cMapUrl, cMapPacked: _libs.PDFJS.cMapPacked, disableAutoFetch: _libs.PDFJS.disableAutoFetch, disableStream: _libs.PDFJS.disableStream, disableRange: _libs.PDFJS.disableRange, imageResourcesPath: _libs.PDFJS.imageResourcesPath, externalLinkTarget: _libs.PDFJS.externalLinkTarget, disableFontFace: _libs.PDFJS.disableFontFace }, openOptions)), this.task.onProgress = function(data) {
                if (_this.loadingProgress) {
                    ...
                    cur !== old && (cur = isNaN(cur) ? 0 : cur, cur = cur > 100 ? 100 : cur, Promise.resolve().then(function() { _this.loadingProgress(cur) }))
                }
                _this.progresData = data
            }, this.task.promise.then(function(handler) { handler.numPages > 1 ? Promise.all([handler.getPage(1), handler.getPage(2)]).then(function(pages) { _this.init(handler, pages) }) : _this.init(handler) }).catch(function(e) { console.error(e), _this.errorHandler && _this.errorHandler(e) })
        }
        ...
        }, Pdf.prototype.getPageType = function(n) { return this.doubledPages && 0 !== n && n !== this.getPagesNum() - 1 ? 1 & n ? "left" : "right" : "full" }, Pdf.prototype.getPage = function(n) { return this.handler.getPage(this.doubledPages ? Math.ceil(n / 2) + 1 : n + 1) }, Pdf.prototype.getDestination = function(dest) {
            var _this2 = this,
                destPromise = void 0;
            return destPromise = "string" == typeof dest ? this.handler.getDestination(dest) : Promise.resolve(dest), destPromise = destPromise.then(function(dest) { return _this2.handler.getPageIndex(dest[0]) }).then(function(number) { return _this2.doubledPages ? number < 1 ? number : 1 + 2 * (number - 1) : number }).catch(function() { return console.error("Bad bookmark") })
        }, Pdf.prototype.dispose = function() { this.handlerQueue.splice(0, this.handlerQueue.length), delete this.handler }, Pdf.prototype.setLoadingProgressClb = function(clb) { this.loadingProgress = clb }, Pdf.prototype.setErrorHandler = function(eh) { this.errorHandler = eh }, Pdf.prototype.getPagesNum = function() { return this.handler ? this.doubledPages ? 2 * (this.handler.numPages - 1) : this.handler.numPages : void 0 }, Pdf.getPageSize = function(page) {
        ...
        }, Pdf.prototype.getHandler = function(clb) { this.handler ? clb(this.handler) : this.handlerQueue.push(clb) }, Pdf
    }();
    exports.default = Pdf
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _libs = __webpack_require__(0),
        ThreeEventConverterFs = function() {
            ...
            return ThreeEventConverterFs.objectsTest = function(object1, object2) { return !(!object1 || !object2) && object1.object === object2.object }, ThreeEventConverterFs.objectsAndFacesTest = function(object1, object2) { return !(!object1 || !object2) && (object1.object === object2.object && object1.face.materialIndex === object2.face.materialIndex) }, ThreeEventConverterFs.prototype.addThree = function(three) { this.threes.push(three) }, ThreeEventConverterFs.prototype.removeThree = function(three) { var i = this.threes.indexOf(three);~i && this.threes.splice(i, 1) }, ThreeEventConverterFs.prototype.getObject = function(e) { return this.setCoordsFromEvent(e), this.raycaster.setFromCamera(this.coords, this.camera), this.raycaster.intersectObjects(this.threes)[0] }, ThreeEventConverterFs
        }();
    ...
    Array.prototype.fill || (Array.prototype.fill = function(value) { if (null == this) throw new TypeError("this is null or not defined"); for (var O = Object(this), len = O.length >>> 0, start = arguments[1], relativeStart = start >> 0, k = relativeStart < 0 ? Math.max(len + relativeStart, 0) : Math.min(relativeStart, len), end = arguments[2], relativeEnd = void 0 === end ? len : end >> 0, final = relativeEnd < 0 ? Math.max(len + relativeEnd, 0) : Math.min(relativeEnd, len); k < final;) O[k] = value, k++; return O }), Array.prototype.find || Object.defineProperty(Array.prototype, "find", {
        ...
        return -1
    }), Object.values || (Object.values = function(O) { return Object.keys(O).map(function(name) { return O[name] }) || [] }), RegExp.escape || (RegExp.escape = function(s) { return s.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") }), String.prototype.replaceAll || (String.prototype.replaceAll = function(search, replace) { return this.replace(new RegExp(RegExp.escape(search), "g"), replace) }), String.prototype.fb3dQFilter || (String.prototype.fb3dQFilter = function() { return this.replace(/(\n|\t|  )/g, "") })
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        AutoNavigator = function() {
            ...
            }, AutoNavigator.prototype.getPageNumber = function() { var number = parseInt(this.pageN); return (isNaN(number) || 0 === number) && (number = this.getParameterByName(this.urlParam), number = parseInt(number), isNaN(number) && (number = 1)), number - 1 }, AutoNavigator
        }();
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        _libs = __webpack_require__(1),
        _MathUtils = __webpack_require__(5),
        _MathUtils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_MathUtils),
        Binder = function() {
            function Binder(visual, p) {
                var _this = this,
                    hidden = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                _classCallCheck(this, Binder), this.visual = visual, this.p = _extends({}, p, { backSize: 2 * p.cover.depth + p.sheets * p.page.depth }), this.OZ = new _libs.THREE.Vector3(0, 0, 1), this.backG = new _libs.THREE.BoxGeometry(.001, this.p.backSize, p.cover.height);
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        Book = function(_THREE$EventDispatche) {
            function Book(visual, sheets, pageCallback, props) {
                ...
                _this.cssFs = {
                    play: function(player) {
                        if (player.play) player.fb3dNoPlay = !1, (player.play() || { catch: function() {} }).catch(function(e) { player.fb3dNoPlay || "NotAllowedError" !== e.name || (_this.pendingPlayers.push(player), _this.dispatchEvent({ type: "pendingPlayers" })) });
                        else if ((0, _libs.$)(player).hasClass("youtube")) {
                            var p = player.player;
                            player.fb3dNoPlay = !1, p && p.playVideo ? p.playVideo() : setTimeout(function() { player.fb3dNoPlay || _this.cssFs.play(player) }, 200)
                        }
                    },
            ...
            return _inherits(Book, _THREE$EventDispatche), Book.prototype.calculateShadow = function() {
            ...
            }, Book.prototype.updateThree = function() { this.three.userData.needsUpdate = !0 }, Book.prototype.setAutoResolution = function(autoResolution) { this.p.autoResolution = _extends({}, this.p.autoResolution, autoResolution) }, Book.prototype.setZoom = function(zoom, singlePage) {
                ...
                if (!this.flipDisabled) {
                    ...
                    if (this.sheetPhysics.getSize() < 25) {
                        var left = this.sheetBlocks[0],
                            PI = Math.PI;
                        this.angle === PI ? res = this.connectPhysics(block = this.rightCover, this.p.cover.mass, PI, -this.p.cover.startVelocity, this.p.cover.flexibility, 0, function(angle, height) { return _this2.set(3 * PI / 2 - angle / 2, height) }, function(angle, height) { _this2.set(3 * PI / 2 - angle / 2, 0), _this2.setSheetBlocks(angle ? PI : PI / 2 + 1e-7, "closed") }, progressClb) : left && "closed" === left.state && left.angle > PI / 2 ? (block = size < left.getSize() ? this.splitSheetBlock(0, left.getSize() - size)[1] : left, res = this.connectPhysics(block, this.p.page.mass * block.getSize(), PI, -this.p.page.startVelocity, this.p.page.flexibility, 0, function(angle, height) { return block.set(_this2.getClosedBlockAngle(angle), "opened", height, block.p.first, block.p.last, _this2.flipDirection) }, Book.finishAnimationClb.bind({ book: this, block: block }), progressClb)) : this.angle !== PI / 2 && this.angle !== 3 * PI / 2 || (res = this.connectPhysics(block = this.leftCover, this.p.cover.mass, PI, -this.p.cover.startVelocity, this.p.cover.flexibility, 0, function(angle, height) { _this2.set(2 * PI - angle / 2, height), angle > PI / 2 && _this2.setSheetBlocks(angle ? PI / 2 : 0, "closed") }, function(angle, height) { return _this2.set(0 === angle ? 0 : 2 * PI - angle / 2, 0) }, progressClb))
                    }
                    return res
                }
                ...
                if (this.mouseController) {
                    ...
                    if ("mouseover" === e.type) {
                        if (this.hoverInfo && void 0 !== this.hoverInfo.pendings) ++this.hoverInfo.pendings;
                            ...
                            if (n > 1 && n < 2 * (this.p.sheets + 1) && hover.physicId && (hover.angle < .02 || hover.angle > Math.PI - .02)) res = Promise.resolve(hover);
                                ...
                                (!nextBlock || !nextBlock.physicId || nextBlock.angle > .02 && nextBlock.angle < Math.PI - .02) && (res = this.flip(i, 1).then(function(block) { return block ? _this4.sheetPhysics.setParametr(block.physicId, "velocity", 0) : delete _this4.hoverInfo, block }), this.hoverInfo = { pendings: 1 })
                            }
                            res.then(function(block) {
                                if (_this4.hoverInfo && _this4.hoverInfo.pendings < 1 && (block = void 0, delete _this4.hoverInfo), block) {
                                    ...
                                    block.force = _this4.sheetPhysics.getTargetForceClb(p.mass * block.getSize(), i ? Math.PI - .02 : .02), block.cornerForce = function() { return (i ? -1 : 1) * _SheetPhysics2.default.hoverCornerForceClb() }, _this4.sheetPhysics.setParametr(block.physicId, "angle", i ? Math.PI - .01 : .01), _this4.hoverInfo = { n: n, block: block }, _this4.update(1 / 30)
                                }
                            })
                        }
                    ...
                    else if ("mousedown" === e.type) this.cornerClickData = { x: e.pageX, y: e.pageY };
            ...
            }, Book.prototype.setTexture = function(material, n) { this.pageManager.setTexture(material, n) }, Book.prototype.setPageTexture = function(material, n) { this.setTexture(material, n + 2) }, Book.prototype.setLeftCoverTexture = function(material, n) { this.setTexture(material, n) }, Book.prototype.setRightCoverTexture = function(material, n) { this.setTexture(material, n + 2 * (this.p.sheets + 1)) }, Book.finishAnimationClb = function(angle) { this.block.set(this.book.getClosedBlockAngle(angle).closedAngle, "closed", 0); var i = this.book.sheetBlocks.indexOf(this.block);~i && (0 === angle ? this.book.mergeSheetBlocks(i, this.book.sheetBlocks.length - i) : this.book.mergeSheetBlocks(0, i + 1)) }, Book.prototype.calcBlockForce = function(block, object, angle, velocity, cornerHeight) { return block.force ? block.force(object, angle, velocity, cornerHeight) : 0 }, Book.prototype.calcBlockCornerForce = function(block, object, angle, velocity, cornerHeight) { return block.cornerForce ? block.cornerForce(object, angle, velocity, cornerHeight) : 0 }, Book.prototype.setVisualMode = function(mode) {
                ...
                var _this6 = this,
                    res = void 0;
                return this.animationNotification ? res = Promise.reject() : (this.animationNotification = !0, this.dispatchEvent({ type: "beforeAnimation" }), this.setVisualMode("live"), this.flipDisabled = !0, res = this.layerManager.hide().then(function() { return delete _this6.flipDisabled })), res
            }, Book.prototype.notifyAfterAnimation = function() {
                if (this.animationNotification) {
                    var p = this.getPage();
                    this.userDirection.lastTopPage !== p && (this.userDirection.direction = Math.sign(p - this.userDirection.lastTopPage), this.userDirection.lastTopPage = p), delete this.animationNotification, this.setVisualMode("static"), this.layerManager.show(), this.dispatchEvent({ type: "afterAnimation" })
                }
            }, Book.prototype.getUserDirection = function() { return this.userDirection }, Book.prototype.reducePagesWidth = function(reduceWidth) {
                ...
                var _this7 = this,
                    type = function() { return _this7.hoverInfo ? "hover" : _this7.dragInfo ? "drag" : "free" },
                ...
                return block !== this.leftCover && block !== this.rightCover || (this.bookShadowMaterial.opacity = 0), res.then(function() {
                    return block.physicId = _this7.sheetPhysics.addObject(mass, angle, velocity, flexibility, coverHeight, function(angl, ch) { simulateClb(angl, ch), progressClb(block, Math.abs(angle - angl) / Math.PI, "process", type()), _this7.calculateShadow(), _this7.updateThree() }, function(angl, ch) {
                        ...
                        Promise.resolve().then(function() { _this7.sheetPhysics.getSize() || (_this7.notifyAfterAnimation(), _this7.calculateShadow()) }), _this7.updateThree()
                    }, function(object, angle, velocity, cornerHeight) { return _this7.calcBlockForce(block, object, angle, velocity, cornerHeight) }, function(object, angle, velocity, cornerHeight) { return _this7.calcBlockCornerForce(block, object, angle, velocity, cornerHeight) }), progressClb(block, 0, "init", type()), 1 === _this7.sheetPhysics.getSize() && _this7.reducePagesWidth(!1), block
                }).catch(function() {})
                ...
                return c
            }, Book.prototype.prepareProps = function(props) { return this.calcProps(Book.mergeProps((0, _book.props)(), props)) }, Book.mergeProps = function(first, second) { return second = second || {}, _extends({}, first, second, { sheet: _extends({}, first.sheet, second.sheet), cover: _extends({}, first.cover, second.cover), page: _extends({}, first.page, second.page), cssLayerProps: _extends({}, first.cssLayerProps, second.cssLayerProps) }) }, Book.prototype.calcProps = function(props) {
                var depth = props.maxDepth / (props.sheets + 6),
                    p = _extends({}, props, { sheet: _extends({}, props.sheet), cover: _extends({}, props.sheet, props.cover), page: _extends({}, props.sheet, props.page), cssLayerProps: _extends({}, props.cssLayerProps, { $: _libs.$ }) });
                ...
                var height = 10 * p.height,
                    ...
                    cover = _extends({}, sheet, p.cover, { flexibleCorner: flexibleCornerK * p.cover.flexibleCorner, depth: 10 * p.cover.depth, width: width, height: height, padding: 10 * p.cover.padding }),
                    page = _extends({}, sheet, p.page, { flexibleCorner: flexibleCornerK * p.page.flexibleCorner, depth: 10 * p.page.depth, width: cover.width - cover.padding, height: cover.height - 2 * cover.padding }),
                    marker = { use: !1, color: 16711680, size: .01 };
                return cover.color === sheet.color || p.cover.sideTexture || (cover.sideTexture = Book.createSideTexture(cover.color, cover.side)), page.color === sheet.color || p.page.sideTexture || (page.sideTexture = Book.createSideTexture(page.color, page.side)), p.cssLayersLoader && (p.cssLayersLoader = this.cssLayersLoader(p.cssLayersLoader)), _extends({}, p, { scale: 10, height: height, width: width, flipProgressClb: flipProgressClb, cover: cover, page: page, marker: marker })
                ...
                var _this10 = this,
                    clIfEx = function(f) {
                        var r = void 0;
                        if (f) try { r = f() } catch (e) { console.error(e) }
                        return r
                    };
                return function(c, p) {
                    var o = {};
                    ...
                    for (var no = _this10.cssLayerJsObjectInit(c, p), ro = {}, _arr = ["hide", "hidden", "show", "shown", "dispose"], _loop = function() {
                            var n = _arr[_i10];
                            ro[n] = function() { clIfEx(no[n]), clIfEx(o[n]) }
                ...
                if (ys.length) {
                    ...
                    var p01 = function(n, nm, d) { return void 0 === n.attr(nm) ? d : "true" === n.attr(nm) ? 1 : 0 };
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) { return typeof obj } : function(obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj },
        ...
        BookController = function(_Controller) {
            ...
            return _inherits(BookController, _Controller), BookController.prototype.dispose = function() { _FullScreenX2.default.removeEventListener(this.view.getParentContainer().ownerDocument, this.binds.onScreenModeChanged), delete this.book, delete this.view, delete this.visual }, BookController.prototype.ready = function(scene) {
                ...
                visible = visible || this.printer && this.printer.loading, visible ? this.pendingLoadingAnimation || (this.pendingLoadingAnimation = !0, setTimeout(function() { _this3.pendingLoadingAnimation && _this3.view && _this3.view.setState("widLoading", { visible: visible }) }, 2e3)) : (delete this.pendingLoadingAnimation, this.view.setState("widLoading", { visible: visible }))
                ...
                var _this5 = this;
                this.canFlipLeft() && (this.state.singlePage ? (this.state.activeSide = (this.getPage() + 1) % 2, this.state.activeSide ? (this.state.activeSide = 0, this.updateView()) : this.startFlip(this.book.flipLeft(1)).then(function(block) { block && (_this5.state.activeSide = 1) })) : this.startFlip(this.book.flipLeft(1)))
            }, BookController.prototype.cmdBigBackward = function() { this.cmdBackward() }, BookController.prototype.cmdForward = function() {
                var _this6 = this;
                this.canFlipRight() && (this.state.singlePage ? (this.state.activeSide = (this.getPage() + 1) % 2, this.state.activeSide ? this.startFlip(this.book.flipRight(1)).then(function(block) { block && (_this6.state.activeSide = 0) }) : (this.state.activeSide = 1, this.updateView())) : this.startFlip(this.book.flipRight(1)))
            }, BookController.prototype.cmdBigForward = function() { this.cmdForward() }, BookController.prototype.cmdSave = function() {
                ...
                var setClb = function(fl, time, clb) { return new Promise(function(resolve) { setTimeout(function() { fl < 0 ? _this7.startFlip(_this7.book.flipLeft(-fl, clb)) : _this7.startFlip(_this7.book.flipRight(fl, clb)), resolve() }, time) }) };
                if (2 === covs) setClb(flips[0], 0, function(block, progress, state) { "finish" == state && 1 == progress && setClb(flips[flips.length - 1], 0) }).then(function() { return setClb(flips[1], 400) });
                else
                    for (var next = Promise.resolve(), time = 0, _iterator2 = flips, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
                        var _ref2, _ret = function() {
                            ...
                            var fl = _ref2,
                                t = time;
                            next = next.then(function() { return setClb(fl, t) }), time = 400
                        }();
                        if ("break" === _ret) break
                    }
                ...
                var _this9 = this,
                    isSwipping = function(name) { return _this9.actions.touchCmdSwipe.enabled && _this9.actions.touchCmdSwipe.code === _this9.actions[name].code && _this9.state.smartPan && _this9.bookWatcher.scale <= 1 },
                    cmds = {};
                for (var name in this) ! function(name) { 0 === name.indexOf("cmd") && (cmds[name] = { activate: function() { _this9.viewState && _this9.viewState[name].enable && _this9[name].apply(_this9, arguments) } }) }(name);
                return _extends({}, cmds, {
                    cmdPanLeft: { activate: function(e) { return _this9.orbit.actions.pan(e, { state: "move", dx: -_this9.p.pan.speed, dy: 0 }) } },
                    cmdPanRight: { activate: function(e) { return _this9.orbit.actions.pan(e, { state: "move", dx: _this9.p.pan.speed, dy: 0 }) } },
                    cmdPanUp: { activate: function(e) { return _this9.orbit.actions.pan(e, { state: "move", dx: 0, dy: -_this9.p.pan.speed }) } },
                    cmdPanDown: { activate: function(e) { return _this9.orbit.actions.pan(e, { state: "move", dx: 0, dy: _this9.p.pan.speed }) } },
                    mouseCmdRotate: { activate: this.orbit.actions.rotate },
                    mouseCmdDragZoom: { activate: function(e, data) { data.dy > 0 ? _this9.cmdZoomOut() : data.dy < 0 && _this9.cmdZoomIn() } },
                    ...
                    touchCmdRotate: { activate: function(e, data) { isSwipping("touchCmdRotate") || ("move" === data.state && e.preventDefault(), _this9.orbit.actions.rotate(e, data)) } },
                    touchCmdZoom: { activate: function(e, data) { if (!isSwipping("touchCmdZoom")) { var l = function(v) { return Math.sqrt(v.x * v.x + v.y * v.y) }; "start" === data.state ? _this9.touchZoomData = { l: l(data), scale: _this9.bookWatcher.scale } : "move" === data.state && (e.preventDefault(), _this9.setScale(l(data) / _this9.touchZoomData.l * _this9.touchZoomData.scale)) } } },
                    touchCmdPan: { activate: function(e, data) { isSwipping("touchCmdPan") || "move" === data.state && (!_this9.state.smartPan || _this9.bookWatcher.scale > 1) && (e.preventDefault(), _this9.orbit.actions.pan(e, data)) } },
                    touchCmdSwipe: {
                        activate: function(e, data) {
                            if (isSwipping("touchCmdSwipe"))
                                if ("start" === data.state) {
                                    var touch = (e.touches || e.originalEvent.touches)[_this9.actions.touchCmdSwipe.code - 1];
                                    _this9.swipeData = { handled: !1, x0: touch.pageX, y0: touch.pageY, x: touch.pageX, y: touch.pageY }
                                } else "move" === data.state ? _this9.swipeData.handled || (_this9.swipeData = _extends({}, _this9.swipeData, { x: _this9.swipeData.x + data.dx, y: _this9.swipeData.y + data.dy }), Math.abs(_this9.swipeData.x0 - _this9.swipeData.x) > 100 && (_this9.swipeData.x0 > _this9.swipeData.x ? _this9.cmdForward() : _this9.cmdBackward(), _this9.swipeData.handled = !0)) : delete _this9.swipeData
                        }
                    },
                ...
                var _this10 = this;
                this.eToA = new _EventsToActions2.default((0, _libs.$)(this.visual.element)), this.eToA.addAction(function(e) { return e.preventDefault() }, "contextmenu", _EventsToActions2.default.mouseButtons.Right, 0), this.eToA.addAction(function(e) { return (0, _libs.$)(_this10.view.getParentContainer()).trigger(e) }, "keydown", 27, 0), this.actions = this.getActions();
            ...
            }, BookController.calcProps = function(props) { return props.scale.delta = (props.scale.max - props.scale.min) / props.scale.levels, props }, BookController
        }(_Controller3.default);
    ...
    var _libs = __webpack_require__(1),
        BookPrinter = function(_THREE$EventDispatche) {
            ...
            return _inherits(BookPrinter, _THREE$EventDispatche), BookPrinter.prototype.cancel = function() { this.canceled = !0 }, BookPrinter.prototype.dispose = function() { this.frame && (this.frame.remove(), delete this.frame) }, BookPrinter.prototype.print = function() {
                var _this2 = this;
                if (!this.loading)
                    if (delete this.canceled, "pdf" === this.type) {
                        var printWnd = void 0,
                            callManually = !1;
                        this.useIFrame() ? (callManually = !!this.frame, this.frame || (this.frame = (0, _libs.$)('<iframe src="' + this.pdfSrc + '" style="display: none;"></iframe>').appendTo(document.body)), printWnd = this.frame[0].contentWindow) : printWnd = this.wnd.open(this.pdfSrc), callManually ? printWnd.print() : (this.loading = !0, this.dispatchEvent({ type: "loading" }), (0, _libs.$)(this.frame).on("load", function() { setTimeout(function() { delete _this2.loading, _this2.dispatchEvent({ type: "loaded" }); try { printWnd.print() } catch (e) { console.error(e) } }, 1e3) }))
    ...
    var _View2 = (__webpack_require__(1), __webpack_require__(69)),
        _View3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_View2),
        BookView = function(_View) {
            function BookView(container, onLoad, template, handler) { return _classCallCheck(this, BookView), _possibleConstructorReturn(this, _View.call(this, container, onLoad, template, handler)) }
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        _SheetBlock3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_SheetBlock2),
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        _SheetCssLayer2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_SheetCssLayer),
        CssLayersManager = function() {
            function CssLayersManager(book) { _classCallCheck(this, CssLayersManager), this.book = book, this.props = book.p.cssLayerProps, this.visual = book.visual, this.pageManager = book.pageManager, this.wrappers = {}, this.pendings = [] }
            return CssLayersManager.prototype.getActives = function() {
                ...
                for (var _iterator = Object.values(this.wrappers), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                    ...
                    _ref.layers.forEach(function(l) { return l.dispose() })
                }
                                    ...
                                    _this.pageManager.getLayers(n, function(layers) {
                                        var finish = function() {
                                            if (layers.length && _this.wrappers) {
                                                ...
                                                setTimeout(function() {!_this.hidden && ~_this.getActives().indexOf(n) && _w.layers.forEach(function(l) { return l.show() }) }, 10)
                                            }
                                            _w.state = "ready"
                                        };
                ...
                for (var wait = [], _iterator5 = Object.values(this.wrappers), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
                    ...
                    _ref5.layers.forEach(function(l) { return wait.push(l.hide()) })
                }
        ...
        PageManager = function() {
            ...
            return PageManager.prototype.createLoadingTexture = function(p) {
                ...
                if (this.p.autoResolution.enabled) {
                    ...
                    var es = [];
                    this.pageCache.forEach(function(e) { es.push(e) }), es.forEach(function(e) {
                        var object = e[1];
                ...
                var _this2 = this;
                (this.p.cssLayersLoader ? this.p.cssLayersLoader : function(n, f) { return f([]) })(n, function(layers) {
                    ...
                    object && (object.wrapper.getCSSLayer && _this2.p.highlightLinks ? object.wrapper.getCSSLayer() : Promise.resolve()).then(function(l) {
                        (l || layers[0]) && (l = l || {}, layers[0] = layers[0] || {}, layers[0] = { html: (l.html || "") + (layers[0].html || ""), css: (l.css || "") + (layers[0].css || ""), js: layers[0].js }), "active" !== object.state ? object.pendings.push({ clb: clb, args: [layers] }) : clb(layers)
                    })
                })
            ...
            }, PageManager.prototype.rtlPageN = function(n) { return this.p.rtl ? this.book.getBookPages() - 1 - n : n }, PageManager.prototype.load = function(material, n) {
                var _this3 = this,
            ...
            }, PageManager.prototype.isSinglePage = function(o) { return this.p.singlePage }, PageManager.prototype.calcResolution = function(o) {
                var res = void 0;
                if (this.p.autoResolution.enabled) {
                    ...
                    res.width < minRes && (res = { width: minRes, height: minRes * o.heightTexels / o.widthTexels }), res.height < minRes && (res = { width: minRes * o.widthTexels / o.heightTexels, height: minRes }), res.width > maxRes && (res = { width: maxRes, height: maxRes * o.heightTexels / o.widthTexels }), res.height > maxRes && (res = { width: maxRes * o.widthTexels / o.heightTexels, height: maxRes })
                } else res = { width: o.widthTexels, height: o.heightTexels };
                return res
            }, PageManager.prototype.pushInRenderQueue = function(o) { "queuedForRender" !== o.state && "loading" !== o.state && (o.state = "queuedForRender", this.renderQueue.push(o)) }, PageManager.prototype.updateRenderQueue = function() {
                if (this.canvases) {
                    var p = this.p;
                    if (this.rendering) this.rendering.wrapper && this.rendering.wrapper.setRenderPause(!p.renderWhileFlipping && (this.book.isProcessing() || this.visual.getOrbit().isMoving())), this.book.updateThree();
                        ...
                        for (var active = void 0, top = void 0, _iterator7 = this.renderQueue, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
                            ...
                            var _o2 = _ref7;
                            if (!active && _o2.isActive() && (active = _o2), _o2.isTop()) { top = _o2; break }
                        }
                        ...
                        if (this.rendering)
                            if (this.rendering.wrapper && this.rendering.wrapper.startRender) {
                                ...
                                this.nextCanvas = (this.nextCanvas + 1) % this.canvases.length, this.rendering.wrapper.setRenderCanvas(_o.c, _o.ctx), this.rendering.wrapper.setResolution(this.calcResolution(this.rendering)), this.rendering.wrapper.startRender(), this.book.dispatchEvent({ type: "startRendering", page: _o.n })
        ...
        PdfLinksHandler = function() {
            ...
            return PdfLinksHandler.prototype.dispose = function() {}, PdfLinksHandler.prototype.setHandler = function(handler) { this.handler = handler }, PdfLinksHandler.prototype.defaultHandler = function(type, destination) { "internal" === type ? this.ctrl.goToPage(destination) : "external" === type && window.open(destination, "_blank") }, PdfLinksHandler.prototype.callHandlers = function(type, destination) { this.handler && this.handler(type, destination) || this.defaultHandler(type, destination) }, PdfLinksHandler.prototype.handleEvent = function(data) {
                ...
                switch (e.type) {
                    ...
                    case "touchtap":
                    case "click":
                        anno.url ? this.callHandlers("external", anno.url) : anno.dest && this.pdf.getDestination(anno.dest).then(function(number) { return _this.callHandlers("internal", number) })
                }
            }, PdfLinksHandler
        }();
    ...
    var _Finder = __webpack_require__(17),
        _Finder2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_Finder),
        SearchEngine = function() {
            ...
            return SearchEngine.prototype.setQuery = function(query) { this.query = query, this.update = !0, this.process() }, SearchEngine.prototype.process = function() {
                ...
                if (this.update) {
                    ...
                    this.find(this.pageCallback(this.page)).then(function(contexts) { stamp === _this.stamp && (contexts.length && _this.results.push({ page: _this.page, contexts: contexts }), _this.onPageHitsChanged && _this.onPageHitsChanged(_this.page, _this.query), ++_this.page, _this.process()) })
                }
            }, SearchEngine.prototype.find = function(pi) { var _this2 = this; return "pdf" === pi.type ? new Promise(function(resolve) { pi.src.getHandler(function() { var n = void 0 === pi.number ? _this2.page : pi.number; "right" === pi.src.getPageType(n) ? resolve([]) : pi.src.getPage(n).then(function(page) { page.getTextContent().then(function(textContent) { resolve(new _Finder2.default(textContent.items.map(function(item) { return item.str }), _this2.query, { hits: !1 }).getContexts()) }) }).catch(function() { return resolve([]) }) }) }) : Promise.resolve([]) }, SearchEngine
        }();
    ...
    var _libs = __webpack_require__(1),
        ...
        _WidgetController3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_WidgetController2),
        ShareController = function(_WidgetController) {
            function ShareController(view, bookCtrl) {
                var linkBuilder = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function(page) { return page };
            ...
            return _inherits(ShareController, _WidgetController), ShareController.prototype.cmdCloseShare = function() { this.hide() }, ShareController.prototype.clickLink = function(u) {
                ...
                if (this.view) {
                    ...
                    this.view.setState("txtShareLink", { value: this.getLink(), visible: !0 }), _WidgetController.prototype.updateView.call(this)
                }
            }, ShareController
    ...
    var _CSSLayer = __webpack_require__(13),
        _CSSLayer2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_CSSLayer),
        SheetCssLayer = function() {
            ...
            return SheetCssLayer.prototype.dispose = function() { this.layer.dispose(), this.visual.removeCssObject(this.layer) }, SheetCssLayer.prototype.isHidden = function() { return this.layer.isHidden() }, SheetCssLayer.prototype.hide = function() { return this.layer.hide() }, SheetCssLayer.prototype.show = function() { return this.layer.show() }, SheetCssLayer.prototype.set = function(css, html, js) { this.layer.setData(css, html, js) }, SheetCssLayer.prototype.update = function(block) {
                this.block = block;
                var size = block.getTopSize();
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        SheetPhysics = function() {
            ...
            }, SheetPhysics.prototype.findCollisions = function(os) { for (var ci = { num: 0, last: 0, all: [] }, i = 1; i < os.length && ci.num < 2; ++i)(os[i - 1].l > os[i].l || this.isCollision(os[i - 1], os[i])) && (os[i - 1].l > os[i].l && ++ci.num, ++ci.num, ci.last = i, -1 === ci.all.indexOf(i - 1) && ci.all.push(i - 1), -1 === ci.all.indexOf(i) && ci.all.push(i)); return ci }, SheetPhysics.prototype.isCollision = function(a, b) { return Math.abs(a.l - b.l) < this.p.margin && a.v > b.v }, SheetPhysics.prototype.integrate = function(os, dt) {
    ...
    var _libs = __webpack_require__(1),
        _ThreeUtils = __webpack_require__(21),
        _ThreeUtils2 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_ThreeUtils),
        faces = [],
        ...
        mapVertices = function(src, dst) {
            for (var map = [], i = 0; i < src.length; ++i)
                for (var j = 0; j < dst.length; ++j)
                    if (function(a, b) { return Math.abs(a.x - b.x) + Math.abs(a.y - b.y) + Math.abs(a.z - b.z) < 1e-4 }(src[i], dst[j])) { map[i] = j; break }
            return map
        },
    ...
    var _ImageBase2 = (__webpack_require__(0), __webpack_require__(6)),
        _ImageBase3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_ImageBase2),
    ...
    var Dom2Image = function Dom2Image(wnd, doc, cache) {
        ...
        function cloneNode(node, filter, root) {
            ...
            function cloneChildren(original, clone, filter) { var children = original.childNodes; return 0 === children.length ? Promise.resolve(clone) : function(parent, children, filter) { var done = Promise.resolve(); return children.forEach(function(child) { done = done.then(function() { return cloneNode(child, filter) }).then(function(childClone) { childClone && parent.appendChild(childClone) }) }), done }(clone, util.asArray(children), filter).then(function() { return clone }) }

            function processClone(original, clone) {
                function cloneStyle() {! function(source, target) { source.cssText ? target.cssText = source.cssText : function(source, target) { util.asArray(source).forEach(function(name) { target.setProperty(name, source.getPropertyValue(name), source.getPropertyPriority(name)) }) }(source, target) }(self.window.getComputedStyle(original), clone.style) }
                        ...
                        if ("" !== content && "none" !== content) {
                            ...
                            styleElement.appendChild(function(className, element, style) {
                                var selector = "." + className + ":" + element,
                                    cssText = style.cssText ? function(style) { var content = style.getPropertyValue("content"); return style.cssText + " content: " + content + ";" }(style) : function(style) {
                                        function formatProperty(name) { return name + ": " + style.getPropertyValue(name) + (style.getPropertyPriority(name) ? " !important" : "") }
        ...
        var util = function() {
                function mimes() { var WOFF = "application/font-woff"; return { woff: WOFF, woff2: WOFF, ttf: "application/font-truetype", eot: "application/vnd.ms-fontobject", png: "image/png", jpg: "image/jpeg", jpeg: "image/jpeg", gif: "image/gif", tiff: "image/tiff", svg: "image/svg+xml" } }
                ...
                function isDataUrl(url) { return -1 !== url.search(/^(data:)/) }
            ...
            inliner = function() {
                function shouldProcess(string) { return -1 !== string.search(URL_REGEX) }
                ...
                function inlineAll(string, baseUrl, get) { return function() { return !shouldProcess(string) }() ? Promise.resolve(string) : Promise.resolve(string).then(readUrls).then(function(urls) { var done = Promise.resolve(string); return urls.forEach(function(url) { done = done.then(function(string) { return inline(string, url, baseUrl, get) }) }), done }) }
                var URL_REGEX = /url\(['"]?([^'"]+?)['"]?\)/g;
            ...
            images = function() {
                ...
                function inlineAll(node) { return util.isElement(node) ? function(node) { var background = node.style.getPropertyValue("background"); return background ? inliner.inlineAll(background).then(function(inlined) { node.style.setProperty("background", inlined, node.style.getPropertyPriority("background")) }).then(function() { return node }) : Promise.resolve(node) }(node).then(function() { return util.isImage(node) ? newImage(node).inline() : Promise.all(util.asArray(node.childNodes).map(function(child) { return inlineAll(child) })) }) : Promise.resolve(node) }
    ...
    var EventsToActions = function() {
        ...
        }, EventsToActions.prototype.click = function(e) { this.clicks(e, "click") }, EventsToActions.prototype.dblclick = function(e) { this.clicks(e, "dblclick") }, EventsToActions.prototype.touchPick = function(e, flags, touches) {
            var pos = EventsToActions.getPosition(touches);
            this.touchPicked = _extends({}, pos, { actions: this.getActions("touchdrag", touches.length, flags), code: touches.length, flags: flags }), this.fireActions(this.touchPicked.actions, e, _extends({ state: "start" }, pos))
            ...
            if (this.enabled) {
                ...
                if (this.fireActions(this.getActions("touchmove", touches.length, flags), e), this.touchPicked)
                    if (this.touchPicked.code === touches.length && this.touchPicked.flags === flags) {
                        var pos = EventsToActions.getPosition(touches);
                        this.fireActions(this.touchPicked.actions, e, _extends({ state: "move", dx: pos.x - this.touchPicked.x, dy: pos.y - this.touchPicked.y }, pos)), this.touchPicked = _extends({}, this.touchPicked, pos)
    ...
    var _libs = __webpack_require__(0),
        ...
        LoadingAnimation = function() {
            function LoadingAnimation(width, height, color) { _classCallCheck(this, LoadingAnimation), this.c = _GraphUtils2.default.createCanvas(width, height), this.p = { g: 9.8, dt: 1 / 60, color: color, updateInterval: .25 }, this.ctx = this.c.getContext("2d"), this.os = [-2, Math.PI / 2], this.t = this.p.updateInterval }
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        Object3DWatcher = function() {
            ...
            return Object3DWatcher.prototype.setPadding = function(padding) { this.padding = padding }, Object3DWatcher.prototype.movePan = function(dv) { this.orbit.pan(dv.x * this.visual.width(), -dv.y * this.visual.height()) }, Object3DWatcher.prototype.vToCamera = function(v) { return v.project(this.camera), { x: .5 * v.x, y: .5 * v.y } }, Object3DWatcher.prototype.computeClientBoundBox = function() {
                ...
                if (Math.sqrt(this.os.vx * this.os.vx + this.os.vy * this.os.vy) > .003 || dv.length() > .003) {
                    ...
                    for (os.tf = function(vx, vy, x, y) { return { x: 75 * (dv.x - x), y: 75 * (dv.y - y) } }; t < T;) t + dt > T && (dt = T - t), os = this.integrate(os, dt), t += dt;
    ...
    var _libs = __webpack_require__(0),
        Orbit = function(_THREE$EventDispatche) {
            ...
            return _inherits(Orbit, _THREE$EventDispatche), Orbit.prototype.setMoving = function(moving) { this.moving = moving }, Orbit.prototype.isMoving = function() { return this.moving }, Orbit
        }(_libs.THREE.EventDispatcher);
    ...
    var _libs = __webpack_require__(0),
        ...
        PdfImage = function(_ImageBase) {
            function PdfImage(context, width, height, color, pdf, n) {
                ...
                }, _this.startRender = function() { _this.pdf.getHandler(_this.render.bind(_this)) }, Promise.resolve().then(function() { return _this.pdf.getHandler(_this.init.bind(_this)) }), _this.cssLayerRequests = [], _this
            }
            return _inherits(PdfImage, _ImageBase), PdfImage.prototype.setQuery = function(query) { this.query = query.trim(), this.textContent && this.setHits(this.textContent) }, PdfImage.prototype.rectSize = function(r) { return { width: r[2] - r[0], height: r[3] - r[1] } }, PdfImage.prototype.createPoly = function(m, p, s) {
            ...
            }, PdfImage.prototype.getSimulatedDoc = function() { return this }, PdfImage.prototype.simulate = function(e, doc, x, y) { this.eventConverter && this.eventConverter.convert(e, { doc: doc, x: x, y: y }) }, PdfImage.prototype.setAnnotations = function(annos) {
                var _this2 = this,
                    t = this.viewport.transform,
                    htmls = [],
                    r = function(n) { return (100 * n + "").substr(0, 5) },
                    targets = [];
                ...
                if (this.finder) {
                    for (var testSz = (this.page.view, (0, _libs.$)('<div style="position: absolute; visibility: hidden;"></div>').appendTo("body")), textDiv = testSz[0], baseOffset = testSz.offset().left, _iterator4 = this.finder.getHits(), _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
                        ...
                        poly = poly.map(function(p) { return { x: p.x / _this4.viewport.width, y: 1 - p.y / _this4.viewport.height } }), this.renderHit(poly)
                    }
                    testSz.remove()
                }
                ...
                (!this.viewport || Math.abs(this.viewport.scale - scale) > 1e-4) && (this.viewport = this.page.getViewport({ scale: scale }), "full" !== this.type && ("right" === this.type ? (this.viewport.offsetX += .5 * this.viewport.width * 1.0005, this.viewport.transform[4] -= .5 * this.viewport.width * 1.0005, this.viewport.width *= .5 / 1.0005) : this.viewport.width /= 2), this.resW = this.width = this.viewport.width, this.resH = this.height = this.viewport.height)
            }, PdfImage.prototype.init = function() {
                var _this5 = this;
                this.type = this.pdf.getPageType(this.n), this.pdf.getPage(this.n).then(function(page) { _this5.page = page, _this5.size = _Pdf2.default.getPageSize(page), "full" !== _this5.type && (_this5.size.width /= 2), page.getAnnotations().then(_this5.setAnnotations.bind(_this5)), page.getTextContent().then(_this5.setHits.bind(_this5)), _this5.calcViewport(), _this5.finishLoad() }).catch(function(e) { console.error("Cannot load PDF page: " + (_this5.n + 1)), console.error(e), _this5.finishLoad() })
    ...
    var _libs = __webpack_require__(0),
        Search = function() {
            function Search(container, pages) { _classCallCheck(this, Search), this.container = container, this.pages = pages, this.prevResults = [], container.html('\n      <div class="search">\n        <div class="query">\n          <input class="inpQuery" type="text" maxlength="30" value="" />\n        </div>\n        <div class="results">\n        </div>\n        <div class="status">\n\n        </div>\n      </div>\n    '.fb3dQFilter()), this.query = container.find(".query input"), this.results = container.find(".results"), this.status = container.find(".status"), this.binds = { navigate: this.navigate.bind(this), doQuery: this.doQuery.bind(this) }, this.query.on("keydown", this.binds.doQuery), this.results.on("click", this.binds.navigate) }
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        Thumbnails = function() {
            function Thumbnails(context, container, thumbnailsClb, size) {
                ...
                _classCallCheck(this, Thumbnails), this.container = container, this.p = props, this.thumbnailsClb = thumbnailsClb, this.size = size, this.queue = { first: 0, len: 0 }, this.canvas = _GraphUtils2.default.createCanvas(), this.imageFactory = new _ImageFactory2.default(_extends({}, context, { renderCanvas: this.canvas, renderCanvasCtx: this.canvas.getContext("2d") })), this.thumbnails = [];
            ...
            return Thumbnails.prototype.getSize = function() { return this.size }, Thumbnails.prototype.setEnable = function(enable) { this.enable = enable, this.update() }, Thumbnails.prototype.dispose = function() { this.container.find("a").off("click", this.binds.navigate), this.container.off("scroll", this.binds.update), this.container.html(""), this.canvas.height = this.canvas.width = 0, delete this.canvas }, Thumbnails.prototype.setLoadQueue = function(first, len) {
                var _this2 = this;
                first = Math.min(first, this.size - 1), len = Math.min(len, this.size - first), this.queue = { first: first, len: len }, Promise.resolve().then(function() { return _this2.update() })
                ...
                wrapper.onChange = function(canvas) { _this3.setImage(thumbnail, canvas.toDataURL("image/png")), thumbnail.loaded = !0, wrapper.dispose(), _this3.loading = !1, Promise.resolve().then(function() { return _this3.update() }) }
                ...
                if (!this.loading && this.canvas) {
                    ...
                    if (!this.loading)
                        for (var i = this.queue.first; i < this.queue.first + this.queue.len; ++i) { var t = this.thumbnails[i]; if (!t.loaded) { this.load(t); break } }
                }
                ...
                for (var items = this.container.find(".item"), base = this.container.find(".thumbnails").offset().top, _i3 = 0; _i3 < items.length; ++_i3) {
                    ...
                    for (var as = item.find("a"), j = 0; j < as.length; ++j) { as[j].dataThumbnail = this.thumbnails[_i3] }
                }
    ...
    var UserMessageController = (__webpack_require__(0), function() {
        function UserMessageController(view) { _classCallCheck(this, UserMessageController), this.view = view, this.showMessage = !1, this.message = "", this.updateView() }
        return UserMessageController.prototype.dispose = function() { this.updateView(), delete this.view }, UserMessageController.prototype.setError = function(text) { this.showMessage = !0, this.message = ['<div class="text error">', text, "</div>"].join(""), this.updateView() }, UserMessageController.prototype.updateView = function() { this.view && (this.view.setState("widUserMessage", { enable: !0, visible: this.showMessage, active: !1 }), this.view.setState("txtUserMessage", { value: this.message, visible: !0 })) }, UserMessageController
    }());
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        View = function() {
                ...
                var build = function build() {
                    ...
                    "function" == typeof template ? (urls = {}, files = template(), links = [], templateName = files.name) : (links = template.links || _this3.getTemplate().links, urls = { styles: template.styles || _this3.getTemplate().styles, html: [template.html || _this3.getTemplate().html], script: script ? [script] : [] }, templateName = template.name, files = {}), templateName && _this3.container.addClass(templateName), _this3.loadFiles(urls, files).then(function() {
                        for (var _loop4 = function() {
                                ...
                                if (match) try { _this3.styleData = _extends({}, _this3.styleData, JSON.parse(match[1])) } catch (e) { console.error(e) }
            ...
            }, View.prototype.getRootUrl = function() { return location.origin + "/" }, View.prototype.getCurrentUrl = function() { return location.href.substr(0, location.href.lastIndexOf("/") + 1) }, View.prototype.urlResolver = function(baseUrl, url) {
            ...
            }, View.prototype.getStyleData = function() { return this.styleData }, View.prototype.getContainer = function() { return this.container[0] }, View.prototype.getParentContainer = function() { return this.parentContainer[0] }, View.prototype.addHandler = function(handler) { this.handlers.push(handler) }, View.prototype.initView = function() {}, View.setControlState = function(ctrl, defaults, state, stateHandlers) { if (ctrl && ctrl[0]) { var st = _extends({}, defaults, state); for (var _name2 in st) st.hasOwnProperty(_name2) && stateHandlers[_name2] && stateHandlers[_name2](ctrl, st[_name2]) } }, View.prototype.setLinkControlState = function(id, state) { View.setControlState(this.linkControls[id], { visible: !0, active: !1, enable: !0 }, state, View.linkStateHandlers) }, View.prototype.setWidgetControlState = function(id, state) { View.setControlState(this.widgetControls[id], { visible: !0, active: !1, enable: !0 }, state, View.widgetStateHandlers) }, View.prototype.setInputControlState = function(id, state) { View.setControlState(this.inputControls[id], { visible: !0, enable: !0, value: "" }, state, View.inputStateHandlers) }, View.prototype.setTextControlState = function(id, state) { View.setControlState(this.textControls[id], { visible: !0, value: "" }, state, View.textStateHandlers) }, View.prototype.onItemStateChanged = function() {}, View.prototype.setState = function(id, state) {
    ...
    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]) } return target },
        ...
        VisualWorld = function(_THREE$EventDispatche) {
            function VisualWorld(wnd, doc, container) {
                ...
                _this.camera.position.x = 0, _this.camera.position.y = 5.5, _this.camera.position.z = 0, _this.renderer = new _libs.THREE.WebGLRenderer({ alpha: !0, precision: VisualWorld.getPrecision(), antialias: !0 }), _this.renderer.shadowMap.enabled = !0, _this.renderer.shadowMap.type = _libs.THREE.PCFSoftShadowMap, _this.renderer.setClearColor(0, 0), _this.renderer.setPixelRatio(Math.sqrt(_this.wnd.devicePixelRatio || 1)), _this.renderer.setSize(_this.width(), _this.height()), _this.jContainer.append(_this.renderer.domElement), _this.cssRenderer = new _CSS3DRenderer2.default, _this.cssRenderer.setSize(_this.width(), _this.height()), (0, _libs.$)(_this.cssRenderer.domElement).css({ position: "absolute", top: 0, margin: 0, padding: 0 }), _this.jContainer.append(_this.cssRenderer.domElement), _this.element = _this.cssRenderer.domElement, _this.textureLoader = new _libs.THREE.TextureLoader, _this.ambientLight = new _libs.THREE.AmbientLight(16777215), _this.scene.add(_this.ambientLight), _this.light = new _libs.THREE.DirectionalLight(0, 1), _this.light.position.set(-6, 6, -3);
                _this.light.castShadow = !0, _this.light.shadow.camera.left = -3, _this.light.shadow.camera.right = 3, _this.light.shadow.camera.top = 3, _this.light.shadow.camera.bottom = -3, _this.light.shadow.camera.near = .5, _this.light.shadow.camera.far = 20, _this.light.shadow.mapSize.x = 512, _this.light.shadow.mapSize.y = 512, _this.scene.add(_this.light), _this.shadowPlace = new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(10, 10).rotateX(-Math.PI / 2), new _libs.THREE.ShadowMaterial({ color: 0, transparent: !0, opacity: .2 })), _this.shadowPlace.position.set(0, 0, 0), _this.shadowPlace.receiveShadow = !0, _this.shadowPlace.castShadow = !1, _this.scene.add(_this.shadowPlace), _this.controls = new _Orbit2.default(_this.camera, _this), _this.controls.target.y = .5;
                var cssScene = (0, _libs.$)(_this.cssRenderer.domElement).find("div"),
                    tmpVector = new _libs.THREE.Vector3;
                _this.controls.addEventListener("change", function() { _this.camera.getWorldDirection(tmpVector), cssScene.css("display", tmpVector.y - _this.camera.position.y > 0 ? "none" : "block"), _this.updateThree() }), useHelpers && _this.scene.add(new _libs.THREE.AxisHelper(5)), _this.binds = { onWindowResize: _this.onWindowResize.bind(_this), animate: _this.animate.bind(_this) }, (0, _libs.$)(_this.wnd).on("resize", _this.binds.onWindowResize), _this.mouseEvents = new _ThreeMouseEventConverter2.default(_this.wnd, _this.doc, _this), _this.touchEvents = new _ThreeTouchEventConverter2.default(_this.wnd, _this.doc, _this);
            ...
            return _inherits(VisualWorld, _THREE$EventDispatche), VisualWorld.prototype.getDiag = function() {
                ...
                var _this2 = this,
                    ...
                    height = this.height();
                if (width > 1 && height > 1) {
                    var updateCamera = function(camera) { camera.aspect = width / height, camera.updateProjectionMatrix() },
                        updateRenderer = function(renderer) { renderer.setSize(width, height) };
                    if (!this.lastResize || Math.abs(this.lastResize.width - width) + Math.abs(this.lastResize.height - height) > 1) {
                        ...
                        setTimeout(function() { resizeStamp === _this2.resizeStamp && (updateCamera(_this2.camera), updateRenderer(_this2.renderer), updateRenderer(_this2.cssRenderer), _this2.updateThree(), _this2.dispatchEvent({ type: "resize" })) }, 10)
                    }
                } else setTimeout(function() { _this2.onWindowResize() }, 250)
                ...
                var p = function(c, x, y) { var ps = new Uint8Array(4); return c.readPixels(x, y, 1, 1, c.RGBA, c.UNSIGNED_BYTE, ps), ps }(renderer.domElement.getContext("webgl") || renderer.domElement.getContext("experimental-webgl"), 0, 0);
    ...
    var YouTubeApi = function() {
        function YouTubeApi() { _classCallCheck(this, YouTubeApi) }
        return YouTubeApi.init = function() {
            return YouTubeApi.task || (YouTubeApi.task = new Promise(function(resolve) {
                window.YT || (window.YT = { loading: 0, loaded: 0 }), window.YTConfig || (window.YTConfig = { host: "http://www.youtube.com" }), YT.loading || (YT.loading = 1, function() {
                    var l = [];
                    YT.ready = function(f) { YT.loaded ? f() : l.push(f) }, window.onYTReady = function() {
                        YT.loaded = 1;
                        for (var i = 0; i < l.length; i++) try { l[i]() } catch (e) {}
                        resolve()
                    }, YT.setConfig = function(c) { for (var k in c) c.hasOwnProperty(k) && (YTConfig[k] = c[k]) };
    ...
    var _Target2 = __webpack_require__(23),
        _Target3 = function(obj) { return obj && obj.__esModule ? obj : { default: obj } }(_Target2),
    ...
    ! function(f, e) { module.exports = e() }(0, function() {
        var f = function() {
